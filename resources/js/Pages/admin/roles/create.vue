    ...
    <div class="py-12 w-full">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
          <div class="flex p-2">
            <Link :href="route('admin.roles.index')" class="px-4 py-2 bg-green-700 hover:bg-green-500 text-slate-100 rounded-md">Role Index </Link>
            ...
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
              <form @submit.prevent="submitForm">
                ...
                <div class="sm:col-span-6">
                  ...
                  <!-- <div v-if="errors.name" class="text-red-400 text-sm">{{ errors.name }}</div> -->
                </div>
...
import { Link } from '@inertiajs/vue3'
  export default {
    ...
    methods: {
        async submitForm() {
            const response = await this.$inertia.post(route('admin.roles.store'), this.form)
        }
